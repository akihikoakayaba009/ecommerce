        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <div class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded">
                    @if($product->cover)
                        <img src="{{ asset($product->cover) }}" alt="Capa do Produto" class="w-full h-full object-cover object-center">
                    @else
                        <img src="https://dummyimage.com/400x400" alt="Sem Imagem" class="w-full h-full object-cover object-center">
                    @endif
                </div>
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex mb-4">
                        <span class="flex items-center">
                            ...
                            @endfor
                            <span class="text-gray-600 ml-3">4 comentários</span>
                        </span>
